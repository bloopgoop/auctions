...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winner', models.CharField(blank=True, default='', max_length=150)),
                ('title', models.CharField(max_length=64)),
                ('description', models.CharField(max_length=512)),
                ('starting_bid', models.DecimalField(decimal_places=2, max_digits=10)),
                ('buyout', models.DecimalField(decimal_places=2, max_digits=10)),
                ('current_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('start_time', models.DateTimeField(auto_now_add=True)),
                ('duration', models.DurationField()),
                ('closed', models.BooleanField(default=False)),
                ('image', models.URLField(blank=True)),
                ('category', models.CharField(choices=[('FAS', 'Fashion'), ('TEC', 'Technology'), ('TOY', 'Toys'), ('HOM', 'Home'), ('OTH', 'Other')], default='OTH', max_length=3)),
